...
const CATEGORIES: Category[] = [
  { slug: "date-night",    title: "Top Date Night",   query: "best date night restaurants in {city}" },
  { slug: "late-night",    title: "Top Late Night",   query: "late night food in {city}" },
  { slug: "brunch",        title: "Top Brunch",       query: "best brunch in {city}" },
  { slug: "burgers",       title: "Top Burgers",      query: "best burgers in {city}" },
  { slug: "wings",         title: "Top Wings",        query: "best wings in {city}" },
  { slug: "hummus",        title: "Top Hummus",       query: "best hummus in {city}" },
  { slug: "steaks",        title: "Top Steaks",       query: "best steakhouse in {city}" },
  { slug: "pizza",         title: "Top Pizza",        query: "best pizza in {city}" },
  { slug: "tacos",         title: "Top Tacos",        query: "best tacos in {city}" },
  { slug: "sushi",         title: "Top Sushi",        query: "best sushi in {city}" },
  { slug: "bbq",           title: "Top BBQ",          query: "best bbq in {city}" },
  { slug: "american",      title: "Top American",     query: "best american restaurants in {city}" },
  { slug: "italian",       title: "Top Italian",      query: "best italian restaurants in {city}" },
  { slug: "caribbean",     title: "Top Caribbean",    query: "best caribbean restaurants in {city}" },
