...
export const NOTES: Note[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { h2: "The implication" },
      "If you take Palate seriously for a few weeks, you'll learn things about yourself that you'd have sworn weren't true. People discover they're café dwellers when they thought they were varied. They discover they're loyalists when they thought they were exploratory. They discover they eat out 3x more than they thought.",
  ...
  {
    slug: "the-frequency-gap",
    title: "Most people guess 2 or 3. The real number is 5.9.",
    dek: "How often you actually eat out is the most underestimated number in your life. Here's why that matters.",
    publishedAt: "2026-04-30",
    author: "Kenton McNeal",
    readingMinutes: 3,
    body: [
      ...
      "When I ask people how often they eat out, they almost always guess two or three times a week. The real number is twice that. The gap between guess and truth is where Palate lives.",
      ...
      "The point isn't to eat out less. Some people will look at the real number and feel fine — that's their entertainment, their socializing, their mental break. Others will look at it and want to redirect.",
